...
interface SdkMcpToolDefinition<Schema extends Record<string, unknown> = Record<string, unknown>> {
    name: string;
    description: string;
    inputSchema: Schema;
...
interface Options {
    ...
    sandbox?: NetworkSandboxSettings;
 ...
 * ```
 */
declare function tool<Schema extends Record<string, unknown>>(name: string, description: string, inputSchema: Schema, handler: (args: Record<string, unknown>, extra: unknown) => Promise<CallToolResult>): SdkMcpToolDefinition<Schema>;
...
interface CreateSdkMcpServerOptions {
    ...
    tools?: Array<SdkMcpToolDefinition<Record<string, unknown>>>;
}
/**
 ...
 *   {
 *     location: 'string',
 *     unit: { enum: ['celsius', 'fahrenheit'], optional: true }
 *   },
